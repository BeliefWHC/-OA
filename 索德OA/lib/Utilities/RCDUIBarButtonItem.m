...
- (RCDUIBarButtonItem *)initWithLeftBarButton:(NSString *)title target:(id)target action:(SEL)method{
    ...
    return [self initContainImage:[UIImage imageNamed:@"back"] imageViewFrame:CGRectMake(0, 4, 10, 17) buttonTitle:title titleColor:[RCIM sharedRCIM].globalNavigationBarTintColor titleFrame:CGRectMake(15, 4, 85, 17) buttonFrame:CGRectMake(-4, 0, 87, 23) target:target action:method];
}
