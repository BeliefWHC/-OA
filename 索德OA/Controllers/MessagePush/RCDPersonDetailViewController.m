...
- (void)viewDidLoad {
    ...
    if (portraitUri.length == 0) {
        ...
        [self.ivAva sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@bpmx%@",BPMX_LOCAL,portraitUri]]
...
//    }
    ...
    remarksView.backgroundColor = [UIColor colorWithHexString:@"f0f0f6" alpha:1];
...
- (void)setPhoneNumber {
    ...
    [NSString stringWithFormat:@"手机号: 110111111111"];
    ...
    self.phonenumber =
    [NSString stringWithFormat:@"1110"];
