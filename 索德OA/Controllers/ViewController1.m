...
@interface ViewController1 () <UITableViewDataSource, UITableViewDelegate, SPCarouselViewDelegate>
...
- (void)viewDidLoad {
    ...
    // 本地图片数组
    self.localPhotos = @[@"lunbo1.jpg",@"lunbo2.jpg",@"lunbo3.jpg",@"lunbo4.jpg",@"lunbo5.jpg"];
...
- (void)setupPropertyForCarouselView:(SPCarouselView *)carouselView {
    ...
    // 是否显示pageControl
    carouselView.showPageControl = YES;
    // 设置轮播图图片的展示模式
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"索德新闻%ld",(long)indexPath.row];
    return cell;
}
